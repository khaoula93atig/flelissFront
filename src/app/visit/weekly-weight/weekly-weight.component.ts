...
export class WeeklyWeightComponent implements OnInit {
  ...
  weights: any[] = [];
  beards: any[] = [];
  counts = [{'value': '0-0.2', 'count': 0}, {'value': '0.2-0.4', 'count': 0}, {'value': '0.4-0.6', 'count': 0}, {
    'value': '0.6-0.8',
    'count': 0
  }, {'value': '0.8-1', 'count': 0}, {'value': '1-1.2', 'count': 0}, {'value': '1.2-1.4', 'count': 0}
  ...
  submitWeight(): void {
    ...
    if (
      ...
      let weeklyWeightMeasurement: WeeklyWeightMeasurement = new WeeklyWeightMeasurement();
  ...
  getweeklyweightbyBreed() {
    this.counts = [{'value': '0-0.2', 'count': 0}, {'value': '0.2-0.4', 'count': 0}, {'value': '0.4-0.6', 'count': 0}, {
      'value': '0.6-0.8',
      'count': 0
    }, {'value': '0.8-1', 'count': 0}, {'value': '1-1.2', 'count': 0}, {'value': '1.2-1.4', 'count': 0}
      , {'value': '1.4-1.6', 'count': 0}, {'value': '1.8-2', 'count': 0}, {'value': '2-2.2', 'count': 0}, {'value': '2.2-2.4', 'count': 0},
