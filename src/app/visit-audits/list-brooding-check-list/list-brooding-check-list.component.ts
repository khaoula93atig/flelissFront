...
export class ListBroodingCheckListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.visitAuditsService.getBroodingCheckByFarm(this.farmId).subscribe(data=>{console.log(data)
      this.visits=data
    })
        ...
        },
        {
          ...
          table: {headerRows:1,
            body: [["", "", "Status"],
              ...
              [{text:"Check delivery", bold: true,rowSpan:7}, "Delivery vehicle temperature (chick box :32°C outside chickbox : 24°C)", this.breedingDetail.deliveryVehiTemp],
              ...
              [{text:"The arrival",bold: true,rowSpan:5}, "Internal chick temperature : (40°C-41°C)", this.breedingDetail.internalChickTemp],
              ...
              [{text:"After installation",bold: true,rowSpan:4}, "Check chick behavior after 1-2 hours", this.breedingDetail.checkChickBehavior],
